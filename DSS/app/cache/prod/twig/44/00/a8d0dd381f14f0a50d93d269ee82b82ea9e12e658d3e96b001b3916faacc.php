...
class __TwigTemplate_4400a8d0dd381f14f0a50d93d269ee82b82ea9e12e658d3e96b001b3916faacc extends Twig_Template
{
    ...
    <a class=\"";
        ...
        echo "\" href=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("dss_proyecto_gestion_eliminar", array("tabla" => (isset($context["tabla"]) ? $context["tabla"] : null), "nif" => (isset($context["nif"]) ? $context["nif"] : null), "confirmacion" => "si")), "html", null, true);
        echo "\">
    Confirmar
    </a>
