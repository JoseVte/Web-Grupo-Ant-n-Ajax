...
class __TwigTemplate_3959be6c20f9e06b0b679de1136c4b8cd663e2797bd4d8d5b0a05866b6eb7ce5 extends Twig_Template
{
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["factura"]) {
            // line 6
            echo "        <a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("dss_proyecto_contabilidad_factura", array("_format" => "pdf", "pedido" => $this->getAttribute((isset($context["factura"]) ? $context["factura"] : null), "pedidoIdentificador"))), "html", null, true);
            echo "\" target=\"_blank\">Factura del pedido ";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["factura"]) ? $context["factura"] : null), "pedidoIdentificador"), "html", null, true);
            echo "</a> <br>
    ";
        }
