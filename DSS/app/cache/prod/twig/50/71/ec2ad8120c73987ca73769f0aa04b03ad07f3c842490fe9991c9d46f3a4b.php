...
<table>
    ";
        ...
        <td>";
            // line 9
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["serv"]) ? $context["serv"] : null), "nombre"), "html", null, true);
            echo "</td>
        <td>";
            // line 10
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["serv"]) ? $context["serv"] : null), "descripcion"), "html", null, true);
            echo "</td>
        <td>";
            // line 11
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["serv"]) ? $context["serv"] : null), "precioIva"), "html", null, true);
            echo "</td>
    </tr>
    ";
        }
