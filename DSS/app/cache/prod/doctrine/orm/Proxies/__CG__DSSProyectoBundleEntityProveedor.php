 ...
 */
class Proveedor extends \DSS\ProyectoBundle\Entity\Proveedor implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'NIF', 'nombre', 'apellidos', 'direccion', 'telefono', 'email');
        }
