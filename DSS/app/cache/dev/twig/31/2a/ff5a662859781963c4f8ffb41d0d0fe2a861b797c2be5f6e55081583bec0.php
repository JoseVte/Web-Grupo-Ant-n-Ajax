...
class __TwigTemplate_312aff5a662859781963c4f8ffb41d0d0fe2a861b797c2be5f6e55081583bec0 extends Twig_Template
{
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("dss_proyecto_gestion_modificar", array("tabla" => (isset($context["tabla"]) ? $context["tabla"] : $this->getContext($context, "tabla")), "nif" => (isset($context["nif"]) ? $context["nif"] : $this->getContext($context, "nif")))), "html", null, true);
        echo "\">
    ";
        // line 6
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "NIF"), 'row', array("attr" => array("readonly" => true)));
        echo "
    ";
        // line 7
