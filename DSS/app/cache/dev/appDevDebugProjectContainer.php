...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'base_datos_dss', 'user' => 'dss', 'password' => 'dss', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_4bd22246b6afd2fb7e74949cf2cd1ea51dae3d7049f73f9db3000d07c2d789ae');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_4bd22246b6afd2fb7e74949cf2cd1ea51dae3d7049f73f9db3000d07c2d789ae');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_4bd22246b6afd2fb7e74949cf2cd1ea51dae3d7049f73f9db3000d07c2d789ae');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/home/pablo/NetBeansProjects/dss_p2g05/DSS/src/DSS/ProyectoBundle/Entity')), 'DSS\\ProyectoBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('DSSProyectoBundle' => 'DSS\\ProyectoBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['ps_pdf.cache'] = new \PHPPdf\Cache\CacheImpl('File', array('cache_dir' => '/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/cache/dev'));
    }
    ...
    protected function getPsPdf_FacadeBuilderService()
    {
        ...
        $instance->setCache('File', array('cache_dir' => '/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/cache/dev'));
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('DSS\\ProyectoBundle\\Entity\\Usuario' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha1', 1 => false, 2 => 1))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_AdminAreaService()
    {
        ...
        $g = new \Symfony\Component\HttpFoundation\RequestMatcher('^/registro/login');

        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/registro/registro');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/error403');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/info');
        ...
        $n = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $m, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($m, '/'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/registro/logout'));
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/home/pablo/NetBeansProjects/dss_p2g05/DSS/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/home/pablo/NetBeansProjects/dss_p2g05/DSS/app', 'UTF-8');
    }
    ...
    protected function getTemplating_Helper_LogoutUrlService()
    {
        ...
        $instance->registerListener('admin_area', '/registro/logout', 'logout', '_csrf_token', NULL);
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/home/pablo/NetBeansProjects/dss_p2g05/DSS/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/home/pablo/NetBeansProjects/dss_p2g05/DSS/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/home/pablo/NetBeansProjects/dss_p2g05/DSS/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/home/pablo/NetBeansProjects/dss_p2g05/DSS/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/home/pablo/NetBeansProjects/dss_p2g05/DSS/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/home/pablo/NetBeansProjects/dss_p2g05/DSS/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/home/pablo/NetBeansProjects/dss_p2g05/DSS/src/DSS/ProyectoBundle/Resources/views', 'DSSProyecto');
        $instance->addPath('/home/pablo/NetBeansProjects/dss_p2g05/DSS/vendor/psliwa/pdf-bundle/Ps/PdfBundle/Resources/views', 'PsPdf');
        $instance->addPath('/home/pablo/NetBeansProjects/dss_p2g05/DSS/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('/home/pablo/NetBeansProjects/dss_p2g05/DSS/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/home/pablo/NetBeansProjects/dss_p2g05/DSS/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/Resources/views');
        $instance->addPath('/home/pablo/NetBeansProjects/dss_p2g05/DSS/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('b1d7c0cf5d0f0b313a3f016eae07e10f1887c3be');
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['security.user.provider.concrete.usuario'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'DSS\\ProyectoBundle\\Entity\\Usuario', 'NIF', NULL);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/home/pablo/NetBeansProjects/dss_p2g05/DSS/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/home/pablo/NetBeansProjects/dss_p2g05/DSS/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/cache/dev',
            'kernel.logs_dir' => '/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/logs',
            ...
            'database_port' => NULL,
            'database_name' => 'base_datos_dss',
            'database_user' => 'dss',
            'database_password' => 'dss',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'en',
            'secret' => 'b1d7c0cf5d0f0b313a3f016eae07e10f1887c3be',
            'ajax_aplicacion' => array(
                'class' => 'ajax_36ap2458e',
                'div' => 'aplicacion',
            ),
            'ajax_div_flotante' => array(
                'class' => 'ajax_34fd114',
                'div' => 'div_flotante',
                'form' => 'form_a484848',
            ),
            ...
            'debug.container.dump' => '/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'kernel.secret' => 'b1d7c0cf5d0f0b313a3f016eae07e10f1887c3be',
            ...
            'session.save_path' => '/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/home/pablo/NetBeansProjects/dss_p2g05/DSS/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/cache/dev/profiler',
            ...
            'router.resource' => '/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/../web',
            'assetic.write_to' => '/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/cache/dev/doctrine/orm/Proxies',
            ...
            'ps_pdf.cache.options' => array(
                'cache_dir' => '/home/pablo/NetBeansProjects/dss_p2g05/DSS/app/cache/dev',
            ),
